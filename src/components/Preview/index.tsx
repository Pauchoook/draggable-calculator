...
const Preview: React.FC = () => {
  return (
    <div className="preview">
      <svg className="preview__icon" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <h5 className="preview__title">Перетащите сюда</h5>
      <p className="preview__content">любой элемент из левой панели</p>
    </div>
  );
};
